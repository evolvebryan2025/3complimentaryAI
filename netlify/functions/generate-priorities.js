...
<body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;background:#f0f2f5;margin:0;padding:0;">
  <div style="max-width:680px;margin:0 auto;padding:24px 16px;">
    <div style="background:linear-gradient(135deg,#152E47 0%,#FD5811 100%);border-radius:14px 14px 0 0;padding:28px 32px;color:white;">
      <div style="font-size:13px;text-transform:uppercase;letter-spacing:0.08em;opacity:0.8;margin-bottom:4px;">Executive Priority Alignment</div>
    ...
    <div style="background:#f8f9fc;border-radius:0 0 14px 14px;padding:20px 32px;border-top:1px solid #eee;">
      <div style="text-align:center;font-size:12px;color:#888;">
        <strong>Data Sources:</strong> Calendar: ${context.calendar.summary.totalEvents} events | Emails: ${context.emails.summary.totalEmails} messages | Tasks: ${context.tasks.summary.totalTasks} items<br><br>
        Generated by Priority Alignment · Powered by <a href="https://madeeas.com" style="color:#FD5811;text-decoration:none;">MadeEA</a>
      </div>
    </div>
  </div>
</body></html>`;
